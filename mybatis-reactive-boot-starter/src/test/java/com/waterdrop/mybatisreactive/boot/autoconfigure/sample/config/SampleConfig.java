 ...
 */
package com.waterdrop.mybatisreactive.boot.autoconfigure.sample.config;
...
@MapperScan("com.waterdrop.mybatisreactive.boot.autoconfigure.sample.*")
@ComponentScan("com.waterdrop.mybatisreactive.boot.autoconfigure.sample.*")
