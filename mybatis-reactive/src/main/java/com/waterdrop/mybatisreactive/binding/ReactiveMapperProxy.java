 ...
 */
public class ReactiveMapperProxy<T> implements InvocationHandler, Serializable {
  ...
  public ReactiveMapperProxy(ReactiveSqlSession sqlSession, Class<T> mapperInterface, Map<Method, MapperMethodInvoker> methodCache) {
    ...
    try {
      return MapUtil.computeIfAbsent(methodCache, method, m -> {
        if (m.isDefault()) {
          ...
          return new PlainMethodInvoker(new ReactiveMapperMethod(mapperInterface, method, sqlSession.getConfiguration()));
        }
      });
  ...
  private static class PlainMethodInvoker implements MapperMethodInvoker {
    private final ReactiveMapperMethod mapperMethod;

    public PlainMethodInvoker(ReactiveMapperMethod mapperMethod) {
      super();
