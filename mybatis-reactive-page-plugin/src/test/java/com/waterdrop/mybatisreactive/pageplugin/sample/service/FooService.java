 ...
 */
package com.waterdrop.mybatisreactive.pageplugin.sample.service;
...
import com.waterdrop.mybatisreactive.pageplugin.sample.mapper.UserMapper;
...
public class FooService {
  ...
  public Flux<User> listPage(Pagination pagination){
    return userMapper.selectList(pagination);
  }
