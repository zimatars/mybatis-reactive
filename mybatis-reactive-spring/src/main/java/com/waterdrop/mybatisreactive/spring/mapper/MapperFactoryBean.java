 ...
 */
package com.waterdrop.mybatisreactive.spring.mapper;

import com.waterdrop.mybatisreactive.spring.support.ReactiveSqlSessionDaoSupport;
 ...
 *
 * @see com.waterdrop.mybatisreactive.spring.ReactiveSqlSessionTemplate
 */
public class MapperFactoryBean<T> extends ReactiveSqlSessionDaoSupport implements FactoryBean<T> {
