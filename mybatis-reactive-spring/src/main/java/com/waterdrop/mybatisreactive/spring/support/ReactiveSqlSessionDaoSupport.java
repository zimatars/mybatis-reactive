 ...
 */
package com.waterdrop.mybatisreactive.spring.support;
 ...
 * @see ReactiveSqlSessionTemplate
 */
public abstract class ReactiveSqlSessionDaoSupport extends DaoSupport {

  private ReactiveSqlSessionTemplate sqlSessionTemplate;
  ...
  protected ReactiveSqlSessionTemplate createSqlSessionTemplate(ReactiveSqlSessionFactory sqlSessionFactory) {
   ...
   */
  public final ReactiveSqlSessionFactory getSqlSessionFactory() {
   ...
   * @see #setSqlSessionFactory
   */
  public void setSqlSessionTemplate(ReactiveSqlSessionTemplate sqlSessionTemplate) {
   ...
   */
  public ReactiveSqlSessionTemplate getSqlSessionTemplate() {
    return this.sqlSessionTemplate;
  }
